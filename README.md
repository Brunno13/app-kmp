...
### ⏳ Próximos Passos (Fase 1: Fundação MVVM)
- [ ] **Setup Inicial:** Inicialização do projeto base via KMP Wizard com Compose Multiplatform.
- [ ] **Gestão de Dependências:** Configuração do `libs.versions.toml` com as bibliotecas core.
- [ ] **Injeção de Dependência:** Setup do Koin no `commonMain` para gerenciar Repositórios e ViewModels.
- [ ] **Navegação:** Implementação do motor de navegação para a estrutura de Tabs e Stacks.

### ⏳ Fase 2: Dados e Offline-First
